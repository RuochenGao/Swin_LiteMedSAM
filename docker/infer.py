...
parser.add_argument(
    ...
    '--input_dir',
    type=str,
    default='/exports/lkeb-hpc-data/MedSAM/MedSAM_Laptop/val_npz_update/imgs/',
    # required=True,
...
parser.add_argument(
    ...
    type=str,
    default="/exports/lkeb-hpc/dlyu/MedSAM_Lite/distill/work_dir/medsam_lite_0.001_1.pth",
